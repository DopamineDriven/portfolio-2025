  ...
  const handleTouchMove = useCallback(
    (e: React.TouchEvent) => {
      ...
      if (lastTouchYRef.current !== null) {
        const moveDelta =
          (touch.clientY - lastTouchYRef.current) * LAYOUT.TOUCH.SENSITIVITY;
  ...
  return (
    <>
      ...
      <div
        ...
        id="game-container"
        className="mb-4 flex w-full max-w-4xl flex-col items-center"
        tabIndex={-1}>
            ...
            <div
              ...
              <div
                ...
                <motion.div
                  ref={playerPaddleRef}
                  className={cn(
                    "absolute left-0 z-20 rounded-sm",
                    powerShotActive
                      ? "bg-blue-400 shadow-[0_0_15px_5px_rgba(59,130,246,0.7)]"
                      : "bg-blue-500"
                  )}
                  style={{
                ...
                <motion.div
                  ...
                  className="absolute right-0 z-20 rounded-sm bg-red-500"
                  style={{
                    width: LAYOUT.PADDLE.WIDTH,
                    height: computerPaddleHeight,
        ...
        <div className="smxs:flex mt-4 hidden h-24 flex-col items-center">
          {gameState === "playing" && (
