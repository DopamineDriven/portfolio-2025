...
export const projectDetails = {
  "next-chess-bot": {
    ...
    content:
      "Next Chess Bot is an innovative AI-powered chess application built with Next.js. It offers players a challenging opponent and helps improve their game through advanced analysis.",
  ...
  "biolife-xr-experience": {
    ...projects["2"],
    externalLink: "https://www.experience.biolifeplasma.com",
    content:
