...
import useCustomBackToTopScroll from "@/hooks/use-custom-back-to-top-scroll";
...
export function Footer() {
  const newScroll = useCustomBackToTopScroll(2000);
  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-6 container text-center">
