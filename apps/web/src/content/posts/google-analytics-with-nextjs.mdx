...
The `GA_TRACKING_ID` env variable is an identifier provided by google analytics following the creation of a new property. It should begin with `G-*` for all Google Analytics 4 (GA4) properties.
