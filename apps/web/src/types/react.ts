...
export type TsxTargeted19<T extends keyof React.JSX.IntrinsicElements> = {
  [P in T]: Selector<
    InferTsx19<React.JSX.IntrinsicElements[P]>,
    "attribute"
  > & {
    ref?: React.Ref<
      Selector<InferTsx19<React.JSX.IntrinsicElements[P]>, "element">
    >;
  };
}[T];

export type TsxExclude19<
  T extends keyof React.JSX.IntrinsicElements,
  P extends keyof TsxTargeted19<T>
> = RemoveFields<TsxTargeted19<T>, P>;

export type TsxInclude19<
  T extends keyof React.JSX.IntrinsicElements,
  J extends keyof TsxTargeted19<T>
> = RemoveFields<TsxTargeted19<T>, Exclude<keyof TsxTargeted19<T>, J>>;
