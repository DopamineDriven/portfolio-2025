...
const ToastClose = ({ className, ...props }: ToastCloseProps) => (
  <ToastPrimitives.Close
    className={cn(
      "hover:text-foreground absolute right-2 top-2 rounded-md p-1 text-[hsl(222.2,84%,4.9%)]/50 opacity-0 transition-opacity focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
      className
    )}
    toast-close=""
    {...props}>
