          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isPossibleMove
                  ? "relative before:absolute before:left-1/2 before:top-1/2 before:h-4 before:w-4 before:-translate-x-1/2 before:-translate-y-1.5 before:rounded-full before:bg-black/15"
                  : "",
