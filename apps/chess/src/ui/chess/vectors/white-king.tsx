...
export const WhiteKing: FC<TsxExclude<"svg", "fill" | "viewBox" | "xmlns">> = ({
  ...svg
}) => (
  <svg
    viewBox="0 0 35 36"
    ...
    />
    <path
      d="M6.5 28.5C12 25.5 22 25.5 27.5 28.5"
      stroke="black"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
